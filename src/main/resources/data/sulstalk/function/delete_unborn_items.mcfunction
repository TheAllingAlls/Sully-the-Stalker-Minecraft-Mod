...
execute as @e[type=item,scores={sulstalk_pickup_delay=-999999999..}] if score @s sulstalk_pickup_delay matches ..1 positioned as @s if entity @e[type=player,distance=..10] run kill @s
