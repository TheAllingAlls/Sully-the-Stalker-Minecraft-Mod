...
execute positioned ~ ~ ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~10 ~ unless block ~ ~ ~ #sulstalk:can_pass_through run scoreboard players set @s sulstalk_is_in_block 3
