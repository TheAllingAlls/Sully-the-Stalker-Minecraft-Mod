...
execute positioned ~ ~ ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_pass_through
