...
execute if score @s sulstalk_defiled_block_delay matches -1..0 positioned ~ ~-2.5 ~ unless block ~ ~ ~ #sulstalk:can_interact_with run summon item_display ~ ~ ~ {Tags:["sulstalk_block","sulstalk_unaligned","sulstalk_unset"]}
...
execute if entity @e[tag=sulstalk_defiled_block,distance=0..10] if score @s sulstalk_defiled_block_delay matches -1..0 run scoreboard players set @s sulstalk_defiled_block_delay 20
