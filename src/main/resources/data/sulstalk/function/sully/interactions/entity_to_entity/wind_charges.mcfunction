...
execute if score @s sulstalk_wind_charges_direction matches -2 run execute if entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] positioned as @s rotated as @s rotated ~ 0.0 positioned ^0.5 ^ ^1 run summon marker ~ ~ ~ {Tags:["sulstalk_wind_charge_marker"]}
execute if score @s sulstalk_wind_charges_direction matches -1 run execute if entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] positioned as @s rotated as @s rotated ~ 0.0 positioned ^0.1 ^ ^1 run summon marker ~ ~ ~ {Tags:["sulstalk_wind_charge_marker"]}
execute if score @s sulstalk_wind_charges_direction matches 0 run execute if entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] positioned as @s rotated as @s rotated ~ 0.0 positioned ^ ^ ^1 run summon marker ~ ~ ~ {Tags:["sulstalk_wind_charge_marker"]}
execute if score @s sulstalk_wind_charges_direction matches 1 run execute if entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] positioned as @s rotated as @s rotated ~ 0.0 positioned ^-0.1 ^ ^1 run summon marker ~ ~ ~ {Tags:["sulstalk_wind_charge_marker"]}
execute if score @s sulstalk_wind_charges_direction matches 2 run execute if entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] positioned as @s rotated as @s rotated ~ 0.0 positioned ^-0.5 ^ ^1 run summon marker ~ ~ ~ {Tags:["sulstalk_wind_charge_marker"]}
