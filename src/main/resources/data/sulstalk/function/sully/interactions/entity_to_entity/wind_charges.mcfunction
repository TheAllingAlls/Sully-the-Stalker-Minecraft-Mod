...
execute if score @s sulstalk_wind_charges_delay matches -1 run execute unless entity @e[tag=sulstalk_wind_charge,distance=..1,limit=1] run playsound minecraft:entity.breeze.shoot hostile @e[type=player,distance=..20] ~ ~ ~ 1 1 0
