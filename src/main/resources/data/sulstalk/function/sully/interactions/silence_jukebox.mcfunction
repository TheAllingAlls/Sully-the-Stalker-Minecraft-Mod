execute positioned ~ ~ ~ unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~1 ~ ~1 unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~1 ~ ~-1 unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~ ~ ~1 unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~ ~ ~-1 unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~1 ~ ~ unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~-1 ~ ~ unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
execute positioned ~-1 ~ ~1 unless entity @e[tag=sulstalk_defiled_disc,distance=..3,limit=1,sort=nearest] if block ~ ~ ~ #sulstalk:can_destroy_music run summon item ~ ~1 ~ {Tags:["sulstalk_defiled_disc","sulstalk_dropped"],Item:{count:1,id:"stick",components:{"item_name":"Defiled Disc","item_model":"air"}}}
