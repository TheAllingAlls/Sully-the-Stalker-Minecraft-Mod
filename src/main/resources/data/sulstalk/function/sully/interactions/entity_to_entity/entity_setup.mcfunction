...
execute if score @s sulstalk_is_following_entity matches 1 as @e[type=player,scores={sulstalk_followed_entity_id=-999999999..}] if data entity @s {Health:0.0f} positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
...
execute if score @s sulstalk_is_following_entity matches 1 as @e[type=!player,scores={sulstalk_followed_entity_id=-999999999..}] if data entity @s {Health:1.0f} positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
execute if score @s sulstalk_is_following_entity matches 1 as @e[type=!player,scores={sulstalk_followed_entity_id=-999999999..}] if data entity @s {Health:0.0f} positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
