...
execute if score @s sulstalk_stew_type matches 9 if score @s sulstalk_stew_timer matches 96 positioned as @s as @e[distance=..1,type=warden] run spreadplayers ~ ~ 10 10 false @s
