...
execute unless entity @e[type=falling_block,distance=..5,limit=1] run playsound minecraft:block.powder_snow.break block @e[type=player,distance=..20] ~ ~ ~ 1 1 0
execute unless entity @e[type=falling_block,distance=..5,limit=1] run playsound minecraft:entity.witch.throw block @e[type=player,distance=..20] ~ ~ ~ 0.1 0.5 0
