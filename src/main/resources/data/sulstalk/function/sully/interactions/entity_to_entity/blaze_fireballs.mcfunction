...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^0.5 ^1.4 ^ unless entity @e[tag=sulstalk_blaze_fireball_1,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_1","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^ ^1.7 ^ unless entity @e[tag=sulstalk_blaze_fireball_2,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_2","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^-0.5 ^1.4 ^ unless entity @e[tag=sulstalk_blaze_fireball_3,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_3","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^-1 ^0.5 ^ unless entity @e[tag=sulstalk_blaze_fireball_4,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_4","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^1 ^0.5 ^ unless entity @e[tag=sulstalk_blaze_fireball_5,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_5","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^0.9 ^-0.5 ^ unless entity @e[tag=sulstalk_blaze_fireball_6,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_6","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 run execute positioned ^-0.9 ^-0.5 ^ unless entity @e[tag=sulstalk_blaze_fireball_7,distance=..1,limit=1] run summon item_display ~ ~ ~ {Tags:["sulstalk_blaze_fireball_7","sulstalk_special_ability"],Motion:[0.0d,0.0d,0.0d],teleport_duration:5}
