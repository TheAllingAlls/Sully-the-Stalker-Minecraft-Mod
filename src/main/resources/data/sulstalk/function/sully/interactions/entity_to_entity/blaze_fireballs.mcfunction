...
execute if score @s sulstalk_blaze_fireballs_delay matches -1 unless entity @e[tag=sulstalk_blaze_fireball,distance=..3,limit=1] run playsound minecraft:entity.blaze.shoot hostile @e[type=player,distance=..20] ~ ~ ~ 1 1 0
