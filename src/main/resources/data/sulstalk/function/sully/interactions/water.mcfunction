...
execute if score @s sulstalk_underwater matches 1.. positioned as @s rotated as @s if block ^ ^ ^1.15 #sulstalk:can_pass_through run scoreboard players set @s sulstalk_underwater_rotate 0
...
execute if score @s sulstalk_underwater matches 1..3 rotated as @s positioned as @s positioned ~ ~-1 ~ unless block ^ ^ ^0.5 #sulstalk:water_trap if block ^ ^ ^-0.6 #sulstalk:water_trap[waterlogged=true] run scoreboard players set @s sulstalk_underwater_rotate 5
execute if score @s sulstalk_underwater matches 1..3 rotated as @s positioned as @s positioned ~ ~-1 ~ unless block ^ ^ ^0.5 #sulstalk:water_trap if block ^-0.6 ^ ^ #sulstalk:water_trap[waterlogged=true] run scoreboard players set @s sulstalk_underwater_rotate 1
execute if score @s sulstalk_underwater matches 1..3 rotated as @s positioned as @s positioned ~ ~-1 ~ unless block ^ ^ ^0.5 #sulstalk:water_trap if block ^0.6 ^ ^ #sulstalk:water_trap[waterlogged=true] run scoreboard players set @s sulstalk_underwater_rotate 2
