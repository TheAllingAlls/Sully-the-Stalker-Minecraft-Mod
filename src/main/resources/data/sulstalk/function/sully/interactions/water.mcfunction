...
execute if score @s sulstalk_underwater matches 1.. positioned as @s positioned ^ ^ ^1 positioned ~ ~1 ~ unless block ~ ~ ~ #sulstalk:can_be_trapped_under positioned as @s positioned ~ ~-1 ~ unless block ~ ~ ~ #sulstalk:can_be_trapped_under run scoreboard players set @s sulstalk_underwater 2
execute if score @s sulstalk_underwater matches 2.. positioned as @s positioned ^ ^ ^1 positioned ~ ~2 ~ unless block ~ ~ ~ #sulstalk:can_be_trapped_under positioned as @s positioned ~ ~-1 ~ unless block ~ ~ ~ #sulstalk:can_be_trapped_under run scoreboard players set @s sulstalk_underwater 1
