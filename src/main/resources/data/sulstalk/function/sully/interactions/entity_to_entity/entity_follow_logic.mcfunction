...
execute positioned ~ ~-2 ~ as @e[type=player,distance=0.5..2] positioned ~ ~2 ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players remove @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 3
