...
execute positioned as @s as @e[tag=sulstalk_hitbox,distance=..1] unless score @s sulstalk_hitbox_id matches -1999999999.. store result score @s sulstalk_hitbox_id as @e[tag=sulstalk_spawned,distance=..0.1] unless score @s sulstalk_has_hitbox matches 1 run scoreboard players get @s sulstalk_spawned_number
...
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if data entity @s item.components.minecraft:damage unless score @s sulstalk_projectile_durability matches -1999999999.. store result score @s sulstalk_projectile_durability run data get entity @s item.components.minecraft:damage
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if score @s sulstalk_projectile_durability matches -1999999999.. run scoreboard players add @s sulstalk_projectile_durability 1
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if score @s sulstalk_projectile_durability matches -1999999999.. store result entity @s item.components.minecraft:damage int 1 run scoreboard players get @s sulstalk_projectile_durability
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if score @s sulstalk_projectile_durability matches -1999999999.. run scoreboard players reset @s sulstalk_projectile_durability
...
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if score @s sulstalk_projectile_rotation_x matches -1999999999.. if score @s sulstalk_projectile_rotation_y matches -1999999999.. rotated as @s as @e[limit=1,distance=..0.1,tag=sulstalk_spawned] positioned ^ ^-1 ^4 run tp ~ ~ ~
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] unless score @s sulstalk_projectile_rotation_x matches -1999999999.. unless score @s sulstalk_projectile_rotation_y matches -1999999999.. as @e[limit=1,distance=..0.1,tag=sulstalk_spawned] facing entity @e[tag=sulstalk_projectile,distance=..2.25] feet positioned ^ ^-1 ^-4 run tp ~ ~ ~
