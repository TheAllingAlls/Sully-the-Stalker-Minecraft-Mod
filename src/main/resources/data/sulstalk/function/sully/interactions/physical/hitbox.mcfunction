...
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 as @e[tag=sulstalk_hitbox,sort=nearest] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,sort=nearest,limit=1] sulstalk_spawned_number on attacker rotated as @s positioned ^ ^ ^5 positioned ~ ~3 ~ as @e[tag=sulstalk_spawned,sort=nearest] if score @s sulstalk_attacker_id = @e[type=player,sort=nearest,limit=1] sulstalk_attacker_id run tp ~ ~ ~

execute positioned as @s unless score @s sulstalk_should_die matches 0 if score @s sulstalk_damaged matches 1 run summon item ~ ~-0.5 ~ {Tags:["sulstalk_stolen","sulstalk_dropped"],Item:{count:1,id:"minecraft:stick",components:{"item_model":"minecraft:air"}},PickupDelay:20s}
execute positioned as @s unless score @s sulstalk_should_die matches 0 if score @s sulstalk_damaged matches 1 if entity @e[tag=sulstalk_stolen,tag=sulstalk_dropped,type=item,limit=1,distance=..3] run tellraw @a "item"
execute positioned as @s unless score @s sulstalk_should_die matches 0 if score @s sulstalk_damaged matches 1 as @e[tag=sulstalk_stolen,tag=sulstalk_dropped,type=item,limit=1,distance=..3] run data modify entity @s Item.id set from entity @s item.components.minecraft:bundle_contents[-1].id
execute positioned as @s unless score @s sulstalk_should_die matches 0 if score @s sulstalk_damaged matches 1 as @e[tag=sulstalk_stolen,tag=sulstalk_dropped,type=item,limit=1,distance=..3] run data modify entity @s Item.components.minecraft:item_model set from entity @s item.components.minecraft:bundle_contents[-1].components.minecraft:item_model
...
execute positioned as @s if score @s sulstalk_should_die matches 1 unless entity @e[tag=sulstalk_stolen,tag=sulstalk_dropped,type=item,limit=1,distance=..3] run summon item ~ ~1.5 ~ {Motion:[0.0d,0.15d,0.0d],Tags:["sulstalk_stolen","sulstalk_dropped"],Item:{count:1,id:"minecraft:stick",components:{"minecraft:item_model":"minecraft:air"}},PickupDelay:40s}
execute positioned as @s if score @s sulstalk_should_die matches 1 as @e[tag=sulstalk_stolen,tag=sulstalk_dropped,type=item,limit=1,distance=..3] run data modify entity @s Item.id set from entity @e[tag=sulstalk_spawned,limit=1,sort=nearest] item.components.minecraft:bundle_contents[-1].id
...
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged matches 2 run data remove entity @s attack
...
execute positioned as @s unless score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged matches 2 run scoreboard players set @s sulstalk_attacker_id -1
