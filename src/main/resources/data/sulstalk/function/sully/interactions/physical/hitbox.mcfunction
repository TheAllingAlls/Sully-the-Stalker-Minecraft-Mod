...
execute positioned as @s on attacker rotated as @s positioned ^ ^ ^5 positioned ~ ~3 ~ as @e[tag=sulstalk_spawned,limit=1,sort=nearest] if score @s sulstalk_damaged_delay matches -1 run tp ~ ~ ~
