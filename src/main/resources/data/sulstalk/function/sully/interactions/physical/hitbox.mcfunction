...
$execute positioned as @s unless entity @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1,scores={sulstalk_hitbox_id=$(id)}] run scoreboard players set @s sulstalk_has_hitbox 0
...
execute positioned as @s if score @s sulstalk_damaged_delay matches -1 run scoreboard players set @s sulstalk_damaged 1
execute positioned as @s if score @s sulstalk_damaged matches 1 run execute if score @s sulstalk_attack matches 1.. run scoreboard players operation @s sulstalk_health -= @s sulstalk_attack

execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 as @e[tag=sulstalk_projectile,distance=..2.25] run function sulstalk:sully/interactions/physical/hitbox_projectile_damage with entity @s data
...
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 as @e[tag=sulstalk_projectile,type=!#minecraft:arrows,distance=..6,sort=nearest] run function sulstalk:sully/interactions/physical/hitbox_projectile_remove with entity @s data
...
##Mace functionality
$execute if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1,scores={sulstalk_hitbox_id=$(id)}] on attacker run function sulstalk:sully/interactions/physical/hitbox_mace
####
