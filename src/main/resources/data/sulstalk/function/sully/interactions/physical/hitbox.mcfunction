...
execute positioned as @s as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] unless score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number as @e[tag=sulstalk_spawned,distance=..0.1,limit=1] run scoreboard players set @s sulstalk_has_hitbox 0
execute positioned as @s as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number as @e[tag=sulstalk_spawned,distance=..0.1,limit=1] unless score @s sulstalk_has_hitbox matches 1 run scoreboard players set @s sulstalk_has_hitbox 1

execute positioned as @s as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number if data entity @s attack as @e[tag=sulstalk_spawned,distance=..0.1,limit=1] if score @s sulstalk_damaged_delay matches -1 run scoreboard players set @s sulstalk_has_attacker 1
execute positioned as @s store result score @s sulstalk_attacker_id as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number if data entity @s attack on attacker run data get entity @s UUID[0]
execute positioned as @s as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number if data entity @s attack on attacker unless score @s sulstalk_attacker_id matches -2147483647.. store result score @s sulstalk_attacker_id run data get entity @s UUID[0]
...
execute positioned as @s if score @s sulstalk_damaged_delay matches -1 if score @s sulstalk_has_attacker matches 1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number as @e[tag=sulstalk_spawned,distance=..0.1,limit=1] run scoreboard players set @s sulstalk_damaged 1
execute positioned as @s if score @s sulstalk_has_attacker matches 1 store result score @s sulstalk_attack as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker run attribute @s minecraft:attack_damage get
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_attack matches 2.. run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if data entity @s {abilities:{invulnerable:0b}} run item modify entity @s weapon.mainhand [{function:set_damage,damage:-0.005,add:true}]
...
execute positioned as @s positioned ~ ~ ~ if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
execute positioned as @s positioned ~ ~1 ~ if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
execute positioned as @s positioned ~ ~-1 ~ if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
execute positioned as @s positioned ~1 ~ ~ if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
execute positioned as @s positioned ~-1 ~ ~ if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
execute positioned as @s positioned ~ ~ ~1 if score @s sulstalk_has_hitbox matches 1 run execute as @e[type=#minecraft:impact_projectiles,type=!firework_rocket,sort=nearest,limit=1,distance=..1] unless data entity @s {Motion:[0.0d,0.0d,0.0d]} run tag @s add sulstalk_projectile
...
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] if score @s sulstalk_projectile_rotation_x matches -2147483647.. if score @s sulstalk_projectile_rotation_y matches -2147483647.. rotated as @s as @e[limit=1,distance=..0.1,tag=sulstalk_spawned] positioned ^ ^-1 ^4 run tp ~ ~ ~
execute positioned as @s if score @s sulstalk_has_projectile matches 1 if score @s sulstalk_damaged matches 1 run execute as @e[tag=sulstalk_projectile,distance=..2.25] unless score @s sulstalk_projectile_rotation_x matches -2147483647.. unless score @s sulstalk_projectile_rotation_y matches -2147483647.. as @e[limit=1,distance=..0.1,tag=sulstalk_spawned] facing entity @e[tag=sulstalk_projectile,distance=..2.25] feet positioned ^ ^-1 ^-4 run tp ~ ~ ~
...
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 unless score @s sulstalk_is_following_entity matches 1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker rotated as @s positioned ^ ^ ^5 positioned ~ ~3 ~ as @e[tag=sulstalk_spawned,distance=..100] if score @s sulstalk_attacker_id = @e[type=player,sort=nearest,distance=..100,limit=1] sulstalk_attacker_id run tp ~ ~ ~
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 if score @s sulstalk_is_following_entity matches 1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker rotated as @s positioned ^ ^ ^2 positioned ~ ~1 ~ as @e[tag=sulstalk_spawned,distance=..100] if score @s sulstalk_attacker_id = @e[type=player,sort=nearest,distance=..100,limit=1] sulstalk_attacker_id run tp ~ ~ ~

##Mace functionality
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace store result score @s sulstalk_attacker_motion_y run data get entity @s Motion[1] 10000
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace if score @s sulstalk_attacker_motion_y matches ..-5000 positioned as @s run effect give @s resistance 1 255 true
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace[enchantments={wind_burst:1}] if score @s sulstalk_attacker_motion_y matches ..-5000 positioned as @s run effect give @s resistance 2 255 true
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace[enchantments={wind_burst:2}] if score @s sulstalk_attacker_motion_y matches ..-5000 positioned as @s run effect give @s resistance 3 255 true
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace[enchantments={wind_burst:3}] if score @s sulstalk_attacker_motion_y matches ..-5000 positioned as @s run effect give @s resistance 5 255 true
execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number on attacker if items entity @s weapon.mainhand minecraft:mace if score @s sulstalk_attacker_motion_y matches ..-5000 run damage @s 1 cramming
...
execute positioned as @s unless score @s sulstalk_damaged_delay matches -1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number run data remove entity @s attack
...
execute positioned as @s if score @s sulstalk_should_die matches 2 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1] if score @s sulstalk_hitbox_id = @e[tag=sulstalk_spawned,distance=..0.1,limit=1] sulstalk_spawned_number run kill @s
