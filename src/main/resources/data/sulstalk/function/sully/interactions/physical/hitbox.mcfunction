...
execute as @e[tag=sulstalk_spawned,limit=1,sort=nearest] if score @s sulstalk_should_die matches 1 run summon item ~ ~1.5 ~ {Motion:[0.0d,0.15d,0.0d],Tags:["sulstalk_stolen","sulstalk_dropped"],Item:{count:1,id:"minecraft:stick",components:{"item_model":"minecraft:air"}},PickupDelay:1s}
