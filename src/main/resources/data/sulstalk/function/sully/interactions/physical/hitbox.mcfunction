...
$execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 unless score @s sulstalk_is_following_entity matches 1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1,scores={sulstalk_hitbox_id=$(id)}] on attacker rotated as @s positioned ^ ^ ^5 positioned ~ ~3 ~ as @e[tag=sulstalk_spawned,distance=..100,scores={sulstalk_attacker_id=$(attacker_id)}] run tp ~ ~ ~
$execute positioned as @s if score @s sulstalk_has_attacker matches 1 if score @s sulstalk_damaged_delay matches -1 if score @s sulstalk_is_following_entity matches 1 run execute as @e[tag=sulstalk_hitbox,sort=nearest,distance=..10,limit=1,scores={sulstalk_hitbox_id=$(id)}] on attacker rotated as @s positioned ^ ^ ^2 positioned ~ ~1 ~ as @e[tag=sulstalk_spawned,distance=..100,scores={sulstalk_attacker_id=$(attacker_id)}] run tp ~ ~ ~
