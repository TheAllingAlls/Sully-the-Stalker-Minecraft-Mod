...
execute as @e[distance=..20,type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox] if data entity @s Health unless score @s sulstalk_followed_entity_id matches -1999999999.. store result score @s sulstalk_followed_entity_id run data get entity @s UUID[0]
...
execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=-1999999999..}] if data entity @s {abilities:{invulnerable:1b}} if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=-1999999999..}] if data entity @s {Invulnerable:1b} if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0

execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1000..1200 positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.05
...
execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 500..699 positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.07
execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 300..499 positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.08
...
execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1..99 positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.1
execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..},distance=4.9..50] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 1
execute if score @s sulstalk_is_following_entity matches 1 run execute positioned as @s as @e[scores={sulstalk_followed_entity_id=-1999999999..},distance=5..50] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.5

execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_health matches ..10 if score @s sulstalk_followed_entity_id = @e[limit=1,sort=nearest,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=-1999999999..}] if score @s sulstalk_followed_entity_health matches ..200 if score @s sulstalk_followed_entity_id = @e[limit=1,sort=nearest,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0

execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=-1999999999..}] unless data entity @s {active_effects:[{id:"minecraft:poison"}]} positioned as @s positioned ~ ~2 ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..1,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s poison 1 10 true
execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=-1999999999..}] if data entity @s {active_effects:[{id:"minecraft:poison"}]} unless data entity @s {active_effects:[{id:"minecraft:darkness"}]} if score @s sulstalk_followed_entity_health matches ..190 positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s darkness 10 1 true
execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=-1999999999..}] unless data entity @s {active_effects:[{id:"minecraft:wither"}]} positioned as @s positioned ~ ~ ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s wither 2 255 false