...
execute unless score @s sulstalk_is_following_entity matches 1 run execute positioned as @s store result score @s sulstalk_nearby_entities run execute if entity @e[type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox,tag=!sulstalk_storage,distance=..20,nbt={Invulnerable:0b}]
