...
scoreboard objectives add sulstalk_following_entity_player_cooldown trigger ""
...
execute unless score @s sulstalk_following_entity_player_cooldown = @s sulstalk_following_entity_player_cooldown run scoreboard players set @s sulstalk_following_entity_player_cooldown 0
...
execute if score @s sulstalk_half_tick matches 1 unless score @s sulstalk_is_following_entity matches 1 run execute positioned as @s store result score @s sulstalk_nearby_entities run execute if entity @e[type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox,tag=!sulstalk_storage,distance=..20,nbt={Invulnerable:0b}]
...
execute if score @s sulstalk_following_entity_forget matches ..-2 run scoreboard players set @s sulstalk_following_entity_forget 0
...
execute if score @s sulstalk_following_entity_forget matches 0 if score @s sulstalk_following_entity_player_cooldown matches -1 run scoreboard players set @s sulstalk_following_entity_player_cooldown 200
...
execute if score @s sulstalk_follow_priority matches 6 run scoreboard players set @s sulstalk_following_entity_player_cooldown 0
...
execute if score @s sulstalk_quarter_tick matches 1 unless score @s sulstalk_should_follow matches 1 run execute positioned as @s if entity @e[distance=..7,type=player,nbt={abilities:{invulnerable:0b}}] run scoreboard players set @s sulstalk_follow_priority 5
...
execute if score @s sulstalk_quarter_tick matches 1 positioned as @s as @e[type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox,distance=..30] if data entity @s Health store result score @s sulstalk_followed_entity_health run data get entity @s Health 100

execute if score @s sulstalk_other_tick matches 1 positioned as @s as @e[distance=..20,type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox] if score @s sulstalk_followed_entity_health = @s sulstalk_followed_entity_health unless predicate {type:entity_scores,entity:this,scores:{sulstalk_followed_entity_id:{}}} store result score @s sulstalk_followed_entity_id run data get entity @s UUID[0]
...
execute unless score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_should_follow matches 1 if score @s sulstalk_follow_priority matches 1 positioned as @s store result score @s sulstalk_following_entity_id run data get entity @e[sort=random,limit=1,distance=..20] UUID[0]
execute unless score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_should_follow matches 1 if score @s sulstalk_follow_priority matches 2 positioned as @s store result score @s sulstalk_following_entity_id run data get entity @e[sort=nearest,limit=1,distance=..10] UUID[0]
execute unless score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_should_follow matches 1 if score @s sulstalk_follow_priority matches 3 positioned as @s store result score @s sulstalk_following_entity_id run data get entity @e[sort=random,limit=1,distance=..9] UUID[0]
execute unless score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_should_follow matches 1 if score @s sulstalk_follow_priority matches 4 positioned as @s store result score @s sulstalk_following_entity_id run data get entity @e[sort=nearest,limit=1,distance=..9] UUID[0]
execute unless score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_should_follow matches 1 if score @s sulstalk_follow_priority matches 5..6 positioned as @s store result score @s sulstalk_following_entity_id run data get entity @e[type=player,nbt={abilities:{invulnerable:0b}},sort=nearest,limit=1,distance=..20] UUID[0]
execute if predicate {type:entity_scores,entity:this,scores:{sulstalk_following_entity_id:{}}} store result entity @s data.following_entity_id int 1 run scoreboard players get @s sulstalk_following_entity_id
...
execute if score @s sulstalk_following_entity_player_cooldown matches 21.. run scoreboard players remove @s sulstalk_following_entity_player_cooldown 1
execute if score @s sulstalk_following_entity_player_cooldown matches 1..20 unless score @s sulstalk_is_following_entity matches 1 run scoreboard players remove @s sulstalk_following_entity_player_cooldown 1
