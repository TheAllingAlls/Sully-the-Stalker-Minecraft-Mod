...
execute positioned as @s as @e[distance=..20,sort=nearest,type=!item,tag=!sulstalk_spawned,tag=!sulstalk_hitbox] if data entity @s Health store result score @s sulstalk_followed_entity_health run data get entity @s Health 10
...
# execute positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] unless score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
...
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 1000..1200 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.05
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 700..999 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.06
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 500..699 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.07
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 300..499 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.08
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 100..299 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.09
execute if score @s sulstalk_is_following_entity matches 1 if score @s sulstalk_following_entity_forget matches 1..99 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.1
execute if score @s sulstalk_is_following_entity matches 1 positioned as @s as @e[scores={sulstalk_followed_entity_id=-999999999..},distance=5..50] if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.5
...
execute if score @s sulstalk_is_following_entity matches 1 as @e[type=player,scores={sulstalk_followed_entity_id=-999999999..}] if data entity @s {active_effects:[{id:"minecraft:poison"}]} unless data entity @s {active_effects:[{id:"minecraft:darkness"}]} if score @s sulstalk_followed_entity_health matches ..19 positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s darkness 10 1 true
execute positioned as @s if score @s sulstalk_is_following_entity matches 1 as @e[type=player,scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_health matches ..2 if score @s sulstalk_followed_entity_id = @e[limit=1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
execute if score @s sulstalk_is_following_entity matches 1 as @e[type=!player,scores={sulstalk_followed_entity_id=-999999999..}] unless data entity @s {active_effects:[{id:"minecraft:wither"}]} positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s wither 2 255 false
execute positioned as @s if score @s sulstalk_is_following_entity matches 1 as @e[type=!player,scores={sulstalk_followed_entity_id=-999999999..}] if score @s sulstalk_followed_entity_health matches ..20 if score @s sulstalk_followed_entity_id = @e[limit=1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0