...
execute positioned as @s as @e[distance=..20,type=!item,type=!experience_orb,tag=!sulstalk_spawned,tag=!sulstalk_hitbox] if data entity @s Health unless predicate {condition:entity_scores,entity:this,scores:{sulstalk_followed_entity_id:{}}} store result score @s sulstalk_followed_entity_id run data get entity @s UUID[0]
...
$execute positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_is_following_entity 1

# execute positioned as @s as @e[scores={sulstalk_followed_entity_id=-2147483647..}] unless score @s sulstalk_followed_entity_id = @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0

$execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if data entity @s {abilities:{invulnerable:1b}} sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
...
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes run rotate @e[limit=1,distance=..0.1,tag=sulstalk_spawned] facing ^ ^ ^0.1
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 1000..1200 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.05
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 700..999 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.06
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 500..699 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.07
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 300..499 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.08
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 100..299 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.09
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 1..99 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. if score @s sulstalk_following_entity_anger matches ..199 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] sulstalk_following_entity_id run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_anger 1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] sulstalk_following_entity_id run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[type=!player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] sulstalk_following_entity_id run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 1
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=5..50] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.5
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=12..50] sulstalk_following_entity_id facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned] ^ ^ ^0.5

$execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if score @s sulstalk_followed_entity_health matches ..10 if score @s sulstalk_followed_entity_id = @e[limit=1,sort=nearest,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0
$execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if score @s sulstalk_followed_entity_health matches ..200 if score @s sulstalk_followed_entity_id = @e[limit=1,sort=nearest,tag=sulstalk_spawned] sulstalk_following_entity_id run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned] sulstalk_following_entity_forget 0

$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] unless data entity @s {active_effects:[{id:"minecraft:poison"}]} positioned as @s positioned ~ ~2 ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..1,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s poison 1 10 true
$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if data entity @s {active_effects:[{id:"minecraft:poison"}]} unless data entity @s {active_effects:[{id:"minecraft:darkness"}]} if score @s sulstalk_followed_entity_health matches ..190 positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s darkness 10 1 true
$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] unless data entity @s {active_effects:[{id:"minecraft:wither"}]} positioned as @s positioned ~ ~ ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned] sulstalk_following_entity_id run effect give @s wither 2 255 false
...
##Blaze Fireballs
execute positioned as @s rotated as @s if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_is_angry matches 1 if score @s sulstalk_special_ability_type matches 1 run function sulstalk:sully/interactions/entity_to_entity/blaze_fireballs
####

##Wind Charges
execute positioned as @s rotated as @s if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_is_angry matches 1 if score @s sulstalk_special_ability_type matches 2 run function sulstalk:sully/interactions/entity_to_entity/wind_charges
####

##Powder Snowfall
execute positioned as @s rotated as @s if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_is_angry matches 1 if score @s sulstalk_special_ability_type matches 3 run function sulstalk:sully/interactions/entity_to_entity/powder_snowfall
####
