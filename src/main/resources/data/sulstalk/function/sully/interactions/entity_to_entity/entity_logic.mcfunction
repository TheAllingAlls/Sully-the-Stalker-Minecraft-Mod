...
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes run rotate @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] facing ^ ^ ^0.1
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 1000..1200 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.05
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 700..999 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.06
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 500..699 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.07
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 300..499 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.08
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 100..299 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.09
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_should_move matches -1 unless score @s sulstalk_special_ability_type matches 0 if score @s sulstalk_following_entity_forget matches 1..99 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. if score @s sulstalk_following_entity_anger matches ..199 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_anger 1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_forget 1
$execute if score @s sulstalk_is_following_entity matches 1 run execute if score @s sulstalk_following_entity_forget matches 1.. positioned as @s as @e[type=!player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=4.9..50] run scoreboard players add @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_forget 4
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0.. positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=5..50] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.5
$execute if score @s sulstalk_is_following_entity matches 1 run execute unless score @s sulstalk_special_ability_type matches 0 positioned as @s as @e[scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=12..50] facing entity @s eyes rotated ~ ~-5 run tp @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] ^ ^ ^0.5

$execute positioned as @s if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if score @s sulstalk_followed_entity_health matches ..10 run scoreboard players set @e[limit=1,distance=..0.1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_forget 0
...
$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] unless data entity @s {active_effects:[{id:"minecraft:poison"}]} positioned as @s positioned ~ ~2 ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..1,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_id run effect give @s poison 1 10 true
$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] if data entity @s {active_effects:[{id:"minecraft:poison"}]} unless data entity @s {active_effects:[{id:"minecraft:darkness"}]} if score @s sulstalk_followed_entity_health matches ..190 positioned as @s if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_id run effect give @s darkness 10 1 true
$execute if score @s sulstalk_is_following_entity matches 1 run execute as @e[type=!player,scores={sulstalk_followed_entity_id=$(following_entity_id)},distance=..100] positioned as @s positioned ~ ~ ~ if score @s sulstalk_followed_entity_id = @e[limit=1,distance=..2,tag=sulstalk_spawned,scores={sulstalk_spawned_number=$(id)}] sulstalk_following_entity_id run damage @s 1 cramming
