...
execute positioned ~ ~-0.25 ~ unless entity @e[tag=sulstalk_defiled_block,distance=..1] unless block ~ ~ ~ #sulstalk:can_interact_with run summon item_display ~ ~ ~ {Tags:["sulstalk_defiled_block"],Rotation:[0.0f,-90.0f]}
