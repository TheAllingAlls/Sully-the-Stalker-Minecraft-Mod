...
execute as @e[tag=sulstalk_spawned,tag=sulstalk_unpositioned] positioned as @s run spreadplayers ~ ~ 20 150 false @s
...
execute as @e[tag=sulstalk_positioned] positioned as @s rotated as @s if loaded ~ ~ ~ run execute if entity @e[type=player,distance=..100] run function sulstalk:sully/logic
