...
execute if score @s sulstalk_half_tick matches 1 if score @s sulstalk_spawn > @s sulstalk_spawn_max as @e[tag=sulstalk_spawned,limit=1,sort=random] unless entity @e[type=player,distance=..20] run scoreboard players set @s sulstalk_should_die 1
